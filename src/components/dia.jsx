...
function Astro() {
    ...
    return(
        <div className='p-4 grid grid-cols-2 md:grid-cols-4 gap-4 dark:text-white'>
            <div className='flex flex-col p-2 w-full h-full items-center justify-center border-2 border-zinc-800 rounded-lg dark:border-white'>
